...
/*Implement a class of complex numbers. 
 ...
 Use operator overloading, overload at least the implementation of the following operators: addition, subtraction, multiplication and division.
 */
...
std::istream& operator >> (std::istream &is, ComplexNum &num){
    is >> num.real >> num.im;
    return is;
}
